...
public class Merger {
    ...
    // negatives.
    // # Thus, the key may neither be too relaxed (only country[0]) nor too
    // strict (all attributes).
    // # We assume the data to be relatively clean and to contain mainly person
    // data.
    // # Therefore, we take the first two characters from the given, family name
    // and the city, hoping that all attributes are usually set correctly and
    // that this is unique enough.
    // key = ""
